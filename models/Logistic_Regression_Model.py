...
class Logistic_Regression_Model:
    ...
    def __init__(self, ticker, start, end):
        self.ticker = ticker
        data = Logistic_Regression_Model.get_data(ticker, start, end)
        ...
        self.strategy_rtn = []
        if os.path.isfile("./saved_models/LogReg/"+ticker+".pkl"):
            with open("./saved_models/LogReg/"+ticker+".pkl", "rb") as file:
                self.model = pickle.load(file)
            with open("./saved_models/LogReg/"+ticker+"_features.pkl", "rb") as file:
    ...
    def preprocess_data(self, data):
        ...
        data['returns'] = np.log(data[self.ticker] / data[self.ticker].shift(1))
        data.dropna(inplace=True)
        ...
        data[features_for_scaling] = Logistic_Regression_Model.sc.fit_transform(data[features_for_scaling])
    ...
    def fit(self):
        ...
        with open("./saved_models/LogReg/"+self.ticker+".pkl", 'wb') as file:
    ...
    def feature_selection(self):
        ...
        with open("./saved_models/LogReg/"+self.ticker+"_features.pkl", 'wb') as file:
